      ...
      <div className="w-full max-w-[1218px] mx-auto relative z-10 px-[24px] md:px-12 py-[48px] md:py-24 pt-[98px] pr-[24px] pb-[48px] pl-[24px]">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-20 items-center">
          ...
          <div>
            ...
            >
              Mais de 15 anos liderando operações de alta complexidade. Diretora nacional em uma das 
              maiores redes de saúde do país. Hoje, mentora de líderes que querem ir além.
            </p>
