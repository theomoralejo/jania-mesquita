  ...
  const journey = [
    {
      ...
      description: 'Fundação da primeira clínica e vivência dos desafios do modelo artesanal.'
    },
    {
      year: '2012',
      title: 'Primeira Transformação',
      description: 'Implementação de governança corporativa e escalabilidade operacional.'
    },
    {
      year: '2016',
  ...
  return (
    <main className="pt-24">
        ...
        <div className="container-custom">
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-16">
              <h2 className="text-5xl mb-6 text-black">Missão e Propósito</h2>
              <p className="text-xl text-gray-600 leading-relaxed">
                Minha missão é empoderar médicos e donos de clínicas a construírem negócios sustentáveis, escaláveis e desvinculados da operação diária, permitindo que foquem no que realmente importa: o cuidado estratégico com a saúde dos pacientes e o crescimento inteligente da organização.
              </p>
            </div>

            <div className="bg-black text-white p-12 rounded-2xl p-[28px]">
              <h3 className="text-3xl mb-6 text-white">Por Que Este Trabalho?</h3>
              <p className="text-xl text-gray-300 leading-relaxed mb-6">
                Após anos vivenciando os desafios de gerir uma clínica enquanto mantinha a excelência no atendimento, descobri que o maior obstáculo não era técnico, mas estratégico: a falta de governança corporativa adaptada à realidade da saúde.
              </p>
              <p className="text-xl text-gray-300 leading-relaxed">
                Hoje, dedico-me a traduzir conceitos executivos de alto nível para a linguagem prática das clínicas, criando sistemas que funcionam sem depender exclusivamente do fundador.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="section-padding bg-gray-50">
        <div className="container-custom">
          <h2 className="text-5xl mb-16 text-center text-black">Valores Fundamentais</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {values.map((value, index) => (
              <div key={index} className="bg-white p-8 rounded-2xl border-2 border-gray-200 hover:border-black hover:shadow-xl transition-all duration-300 group">
                <div className="w-12 h-12 bg-black rounded-2xl flex items-center justify-center mb-6 group-hover:scale-110 transition-transform duration-300">
      ...
      <section className="section-padding">
        <div className="container-custom">
          <h2 className="text-5xl mb-16 text-center text-black">Trajetória</h2>
          <div className="max-w-4xl mx-auto space-y-8">
            {journey.map((item, index) => (
              <div key={index} className="flex gap-8 items-start group">
                <div className="flex-shrink-0 w-20 text-right">
                  <div className="inline-block px-4 py-2 bg-black text-white rounded-xl group-hover:scale-110 transition-transform duration-300">
                    {item.year}
                  </div>
                </div>
                <div className="flex-grow pb-8 border-l-2 border-gray-200 pl-8 group-hover:border-black transition-colors duration-300">
                  <div className="absolute w-4 h-4 bg-black rounded-full -ml-[41px] mt-2"></div>
                  <h3 className="text-2xl mb-3 text-black">{item.title}</h3>
      ...
      <section className="section-padding">
        <div className="container-custom">
          <div className="max-w-3xl mx-auto text-center">
            <h2 className="text-5xl mb-6 text-black">Vamos Conversar?</h2>
            ...
            <div className="flex flex-wrap gap-4 justify-center">
              ...
              <a href="/contato" className="px-8 py-4 border-2 border-black text-black rounded-xl hover:bg-black hover:text-white transition-all text-center">
                Agendar Conversa
              </a>
            </div>
          </div>
