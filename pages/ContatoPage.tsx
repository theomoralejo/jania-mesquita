        ...
        <div className="container-custom">
          <div className="max-w-3xl">
            ...
            <p className="text-xl text-gray-300">
              Estamos aqui para transformar sua clínica em uma empresa de saúde escalável. Escolha a melhor forma de começarmos esta jornada juntos.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="container-custom">
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
            ...
            <div className="lg:col-span-1 space-y-8">
              <div>
                <h2 className="text-2xl mb-8 text-black">Informações</h2>
                ...
                <div className="space-y-6">
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <a href="mailto:contato@janiamesquita.com.br" className="text-black hover:text-gray-600 transition-colors">
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <a href="tel:+5511999999999" className="text-black hover:text-gray-600 transition-colors">
                        +55 (11) 99999-9999
                      </a>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-black">São Paulo, SP<br />Brasil</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-black">Seg - Sex: 9h às 18h</p>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-gray-50 p-6 rounded-2xl border border-gray-200">
                <h3 className="text-lg mb-3 text-black">Tempo de Resposta</h3>
            ...
            <div className="lg:col-span-2">
              {!submitted ? (
                <form onSubmit={handleSubmit} className="bg-white border-2 border-gray-200 rounded-2xl p-8">
                  <h2 className="text-3xl mb-8 text-black">Envie sua Mensagem</h2>
                  
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                    <div>
                      <label className="block text-sm mb-2 text-black">Nome Completo *</label>
                      <input
                        type="text"
                        name="name"
                        value={formData.name}
                    ...
                    <div>
                      <label className="block text-sm mb-2 text-black">E-mail *</label>
                      <input
                        type="email"
                        name="email"
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                    <div>
                      <label className="block text-sm mb-2 text-black">Telefone</label>
                      <input
                        type="tel"
                        name="phone"
                    ...
                    <div>
                      <label className="block text-sm mb-2 text-black">Assunto *</label>
                      <select
                        name="subject"
                  ...
                  <div className="mb-6">
                    <label className="block text-sm mb-2 text-black">Mensagem *</label>
                    <textarea
                      name="message"
                  ...
                  <button
                    type="submit"
                    className="w-full bg-black text-white py-4 rounded-xl hover:bg-gray-900 transition-all flex items-center justify-center gap-2 group"
                  >
                    Enviar Mensagem
                ...
                <div className="bg-green-50 border-2 border-green-200 rounded-2xl p-12 text-center">
                  ...
                  <h3 className="text-3xl mb-4 text-black">Mensagem Enviada!</h3>
