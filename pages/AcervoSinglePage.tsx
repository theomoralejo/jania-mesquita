          ...
          <div className="flex flex-col md:flex-row items-center gap-12">
            ...
            <div>
               ...
               <p className="text-[#696969] leading-relaxed max-w-2xl font-light">
                 Jania Mesquita é especialista em governança corporativa aplicada à saúde. Com mais de 15 anos de atuação, já transformou a realidade de centenas de clínicas médicas através de sua metodologia proprietária, unindo a visão humanizada da medicina com a eficiência da gestão empresarial.
               </p>
            </div>
          </div>
        </div>
