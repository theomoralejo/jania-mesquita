...
const janiaImage = `${import.meta.env.BASE_URL}assets/img/hero.webp`;
      ...
      <div className="w-full max-w-[1218px] mx-auto relative z-10 px-[24px] md:px-12 py-[48px] md:py-24 pt-[98px] lg:pt-[140px] pr-[24px] pb-[48px] pl-[24px]">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-20 items-center">
          ...
          <div>
            ...
            <h1
              className={`font-serif text-3xl md:text-[48px] lg:text-[56px] mb-6 leading-[1.05] tracking-tight text-[#232323] transition-all duration-1000 delay-150 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'
                }`}
            >
            ...
            {/* Subtitle - Autoridade */}
            <p
              className={`text-lg md:text-xl max-w-xl mb-4 leading-relaxed text-[#414141] transition-all duration-1000 delay-300 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'
                }`}
            >
            ...
            <p
              className={`text-base max-w-xl mb-8 md:mb-10 leading-relaxed text-[#696969] transition-all duration-1000 delay-400 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'
                }`}
            >
            ...
            <div
              className={`flex flex-col gap-4 mb-12 md:mb-16 transition-all duration-1000 delay-500 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'
                }`}
            >
              <Link
                to="/avaliacao"
            ...
            {/* Social Proof Rápido */}
            <div
              className={`flex items-center gap-8 text-sm text-[#696969] transition-all duration-1000 delay-600 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'
                }`}
            >
          ...
          <div
            className={`relative transition-all duration-1000 delay-300 order-first lg:order-last ${isVisible ? 'opacity-100 translate-x-0' : 'opacity-0 translate-x-8'
              }`}
          >
        ...
        {/* Stats - Autoridade */}
        <div
          className={`mt-10 md:mt-24 transition-all duration-1000 delay-700 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'
            }`}
        >
