          ...
          <div className="max-w-4xl mx-auto space-y-12">
            ...
            <div>
              <div className="flex items-start gap-4 mb-6">
                ...
                <div>
                  <h2 className="text-3xl mb-3 text-[#42331C]">1. Dados Coletados</h2>
            ...
            <div>
              <div className="flex items-start gap-4 mb-6">
                ...
                <div>
                  <h2 className="text-3xl mb-3 text-[#42331C]">2. Finalidade do Tratamento</h2>
              ...
              <div className="pl-16 space-y-3 text-gray-600">
                <p className="flex items-start gap-3">
                  <span className="w-2 h-2 bg-[#42331C] rounded-full mt-2 flex-shrink-0"></span>
            ...
            <div>
              <div className="flex items-start gap-4 mb-6">
                ...
                <div>
                  <h2 className="text-3xl mb-3 text-[#42331C]">3. Segurança dos Dados</h2>
              ...
              <div className="pl-16 grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="bg-gray-50 p-6 rounded-xl border border-gray-200">
                  <p className="text-[#42331C]">Criptografia SSL/TLS</p>
                </div>
                <div className="bg-gray-50 p-6 rounded-xl border border-gray-200">
                  <p className="text-[#42331C]">Controle de acesso restrito</p>
                </div>
                <div className="bg-gray-50 p-6 rounded-xl border border-gray-200">
                  <p className="text-[#42331C]">Backups regulares</p>
                </div>
                <div className="bg-gray-50 p-6 rounded-xl border border-gray-200">
                  <p className="text-[#42331C]">Monitoramento contínuo</p>
                </div>
              </div>
            </div>
            ...
            <div>
              <div className="flex items-start gap-4 mb-6">
                ...
                <div>
                  <h2 className="text-3xl mb-3 text-[#42331C]">4. Seus Direitos</h2>
              ...
              <div className="pl-16 space-y-3 text-gray-600">
                <p className="flex items-start gap-3">
                  <span className="text-[#42331C] flex-shrink-0">✓</span>
            ...
            <div>
              <div className="flex items-start gap-4 mb-6">
                ...
                <div>
                  <h2 className="text-3xl mb-3 text-[#42331C]">5. Compartilhamento de Dados</h2>
              ...
              <div className="pl-16 mt-4 bg-yellow-50 border border-yellow-200 p-6 rounded-xl">
                <p className="text-gray-600">
                  <strong className="text-[#42331C]">Importante:</strong> Não vendemos, alugamos ou compartilhamos seus dados pessoais para fins comerciais de terceiros.
                </p>
              </div>
            </div>
            ...
            <div>
              <div className="flex items-start gap-4 mb-6">
                ...
                <div>
                  <h2 className="text-3xl mb-3 text-[#42331C]">6. Contato do Encarregado (DPO)</h2>
            ...
            {/* Footer Info */}
            <div className="bg-gray-50 p-8 rounded-2xl border border-gray-200">
              <h3 className="text-xl mb-4 text-[#42331C]">Alterações nesta Política</h3>
